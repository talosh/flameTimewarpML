...
# Four step refinement after initial prediction (5 total)
# Step filters as 192, 144, 128, 96, 64
# Scale list is a fibonacci sequence of [8, 5, 3, 2, 1]
# One step deeper for ResBlocks
...
class Model:
        ...
        class FlownetCas(Module):
            ...
            def forward(self, img0, img1, timestep=0.5, scale=[8, 4, 2, 1], iterations=1):
                if scale == [8, 4, 2, 1]:
                    ...
                    scale = random_scales[random.randint(0, len(random_scales) - 1)]
    ...
    def get_info():
        info = {
            'name': 'flownet4_v001eb8x_fibonacci5',
            'file': 'flownet4_v001eb8x_fibonacci5.py',
            'ratio_support': True,
            'padding': 480
        }
        return info
    ...
    @staticmethod
    def get_name():
        return 'flownet4_v001eb8x_fibonacci5'
