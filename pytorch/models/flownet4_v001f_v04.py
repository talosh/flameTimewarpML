...
class Model:
    ...
    info = {
        'name': 'Flownet4_v001f_v04',
        'file': 'flownet4_v001f_v04.py',
        'ratio_support': True
    }
    ...
    def __init__(self, status = dict(), torch = None):
        ...
        class FlownetCas(Module):
            ...
            def forward(self, img0, img1, timestep=0.5, scale=[16, 8, 4, 1], iterations=1, gt=None):
                ...
                f0xf = self.encode_xf(img0)
                f1xf = self.encode_xf(img1)
                ...
                flow, mask, conf = self.refine00(img0, img1, None, None, None, None, timestep, mask, conf, flow, noise=True, merge=True)
                flow, mask, conf = self.refine01(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine02(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine03(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine04(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine05(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine06(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine07(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine08(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine09(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
                flow, mask, conf = self.refine10(img0, img1, None, None, None, None, timestep, mask, conf, flow, merge=True)
