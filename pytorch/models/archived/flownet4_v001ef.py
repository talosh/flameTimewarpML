...
class Model:
    def __init__(self, status = dict(), torch = None):
        ...
        class Head(Module):
            def __init__(self):
                ...
                self.cnn0 = Multiresblock(3, 32)
                self.cnn1 = torch.nn.Conv2d(32, 48, 3, 2, 1)
                self.cnn2 = Multiresblock(48, 48)
    ...
    def get_info():
        info = {
            'name': 'Flownet4_v001ef',
            'file': 'flownet4_v001ef.py',
            'ratio_support': True
        }
        return info
