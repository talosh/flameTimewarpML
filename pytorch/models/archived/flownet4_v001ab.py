...
# Default scale list are 12, 6, 3, 1
...
class Model:
    def __init__(self, status = dict(), torch = None):
        ...
        class FlownetCas(Module):
            ...
            def forward(self, img0, img1, timestep=0.5, scale=[12, 6, 3, 1], iterations=1):
    ...
    def get_info():
        info = {
            'name': 'Flownet4_v001aa',
            'file': 'flownet4_v001aa.py',
            'ratio_support': True
        }
        return info
