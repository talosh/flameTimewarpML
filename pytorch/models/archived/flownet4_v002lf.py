        ...
        class Flownet(Module):
            def __init__(self, in_planes, c=64):
                ...
                self.lastconv = torch.nn.Sequential(
                    torch.nn.ConvTranspose2d(c, c//2, 8, 2, 3),
                    torch.nn.Conv2d(c//2, c, 3, 1, 1, groups=c//2, bias=False, padding_mode = 'reflect'),
                    torch.nn.Conv2d(c, c, kernel_size=1, stride=1, padding=0, bias=False),
                    torch.nn.ConvTranspose2d(c, 6, 8, 2, 3),
