...
class Model:
    ...
    info = {
        'name': 'Flownet4_v001eb_dv04',
        'file': 'flownet4_v001eb_dv04.py',
        'ratio_support': True
    }
    ...
    def __init__(self, status = dict(), torch = None):
        ...
        class Head(Module):
            def __init__(self):
                ...
                self.attn0 = CBAM(32, channel_scale=-0.1, spatial_scale=0.1)
                self.attn1 = CBAM(32, channel_scale=-0.1, spatial_scale=0.1)
                self.attn2 = CBAM(32, channel_scale=-0.1, spatial_scale=0.1)
