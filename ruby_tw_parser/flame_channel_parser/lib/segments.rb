...
module FlameChannelParser::Segments #:nodoc:
  ...
  class HermiteSegment < LinearSegment #:nodoc:
    ...
    def initialize(from_frame, to_frame, value1, value2, tangent1, tangent2)
      ...
      print "From frame: "
      puts from_frame.inspect
      print "To frame: "
      puts to_frame.inspect
      print "Value1: "
      puts value1.inspect
      print "Value2: "
      puts value2.inspect
      print "Tangent1: "
      puts tangent1.inspect
      print "Tangent2: "
      puts tangent2.inspect
      ...
      print "HERMATRIX: "
      puts HERMATRIX.inspect
      print "@hermite: "
      puts @hermite.inspect
      print "@basis: "
      puts @basis.inspect
    end
    ...
    def value_at(frame)
      ...
      print "Multipliers vec: "
      puts multipliers_vec.inspect
