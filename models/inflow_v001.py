...
class UNet_3Plus(Module):
    ...
    def forward(self, inputs):
        ...
        horisontal_flow0 = norm_flow0[:, 0:1, :, :] * w / 2 # Horizontal component
        vertical_flow0 = norm_flow0[:, 1:2, :, :] * h / 2 # Vertical component
        res_flow0 = torch.cat([horisontal_flow0, vertical_flow0], dim=1)
        
        horisontal_flow1 = norm_flow1[:, 0:1, :, :] * w / 2 # Horizontal component
        vertical_flow1 = norm_flow1[:, 1:2, :, :] * h / 2 # Vertical component
